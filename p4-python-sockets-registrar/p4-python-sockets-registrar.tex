...
\begin{enumerate}
  ...
  \item FIXME: Fork del repositorio en GitHub.
  ...
  \item Estudia el código de un sencillo cliente UDP en \texttt{client.py}. Fíjate en que:
  \begin{enumerate}
  ...
  \begin{enumerate}
    \item Importa el módulo \texttt{SocketServer}. Mira la documentación de Python para ver qué hace.
...
\begin{itemize}
  \item Se valorará que al menos haya siete commits realizados.

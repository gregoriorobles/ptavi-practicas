...
\subsection*{Captura de una sesión SIP}
  ...
  \begin{itemize}
    ...
    \item ¿Sabrías decir qué tipo de servicio ofrece \texttt{sip:500@ekiga.net}?
  \end{itemize}

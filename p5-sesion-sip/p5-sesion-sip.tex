...
Captura una sesión SIP de una conversación con el número SIP \texttt{sip:9999@qxip.net}\footnote{Si estás utilizando tu portátil en vez de una máquina del laboratorio, ten en cuenta que la captura puede ser diferente, porque con el portátil estarás conectado a la red \emph{wifi}, mientras que los ordenadores de los laboratorios lo están a una LAN.}. Tendrás que dar de alta una cuenta en \texttt{www.ekiga.net} con el navegador. Recuerda también que has de comenzar a capturar tramas antes de arrancar Ekiga para ver todo el proceso en el que participa SIP. Para realizar los siguientes ejercicios, deberás crearte una cuenta en \texttt{ekiga.net} y darte de alta la lanzar la aplicación.
  ...
  \item Filtra por los paquetes SIP de la captura y guarda {\bf únicamente} los paquetes SIP como p5.libpcap. Abre el fichero guardado para cerciorarte de que lo has hecho bien. Deberás guardarlo en un archivo de nombre \texttt{p5.libpcap} y añadirlo al repositorio.
...
La entrega de práctica se deberá hacer antes del miércoles 18 de noviembre de 2015 a las 23:55. Para entonces, se debe: 

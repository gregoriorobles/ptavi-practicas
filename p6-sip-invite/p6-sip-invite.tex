...
SIP y los tres primeros y tres últimos {\bf paquetes RTP con audio}\footnote{Nota que los heurísticos de Wireshark identifican los paquetes RTP de mp32rtp como paquetes UDP, por lo que no hace falta que te preocupes si ves que no los identifica como RTP.}.
...
La entrega de práctica se deberá hacer antes del lunes 25 de noviembre de 2019 a las 23:55. Para entonces, se debe tener un repositorio git en GitLab con: 
